...
|:-------|:------:|:--------|
| الدومين (alomran-factory.com) | ⏸️ معلق — بانتظار الإدارة | سؤال م. نادر العواملة |
| الشعار الرسمي | ⏸️ معلق — بانتظار التسليم | متابعة م. سامر الخطيب |
| اختيار مزود الاستضافة | ⏸️ معلق — إعلام العميل قبل الشراء | مقارنة Supernova / Planet |
