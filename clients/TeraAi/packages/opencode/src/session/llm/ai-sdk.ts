import { FinishReason, LLMEvent, ProviderMetadata, ToolResultValue } from "@tera-system/llm"
...
// Move this extraction into @tera-system/llm when Copilot is handled by the native runtime.
