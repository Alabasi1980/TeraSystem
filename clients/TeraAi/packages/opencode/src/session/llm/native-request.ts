import type { JsonSchema, LLMRequest, ProviderMetadata } from "@tera-system/llm"
import { LLM, Message, SystemPart, ToolCallPart, ToolDefinition, ToolResultPart } from "@tera-system/llm"
import {
  AmazonBedrock,
  Anthropic,
  Azure,
...
export const request = (input: RequestInput) => {
  ...
  // @tera-system/llm request objects from opencode's session/AI SDK-shaped data.
  return LLM.request({
