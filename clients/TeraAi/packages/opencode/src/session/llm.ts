...
import { llmClient } from "@tera-system/core/effect/app-node-platform"
...
import type { LLMEvent } from "@tera-system/llm"
import { LLMClient } from "@tera-system/llm/route"
import type { LLMClientService } from "@tera-system/llm/route"
...
> = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const run = Effect.fn("LLM.run")(function* (input: StreamRequest) {
      ...
      // Runtime seam: native is an opt-in adapter over @tera-system/llm. It
