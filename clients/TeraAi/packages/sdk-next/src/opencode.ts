import { OpenCode } from "@tera-system/client/effect"
...
import { createEmbeddedRoutes } from "@tera-system/server/routes"
...
export class Service extends Context.Service<Service, Interface>()("@tera-system/sdk-next/OpenCode") {}
