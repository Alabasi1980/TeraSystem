import type { PluginContext } from "@tera-system/plugin/v2/effect"
...
import type { IntegrationEnvMethod, IntegrationKeyMethod, IntegrationOAuthMethod } from "@tera-system/sdk/v2/types"
