import { convertToOpenAICompatibleChatMessages as convertToCopilotMessages } from "@tera-system/core/github-copilot/chat/convert-to-openai-compatible-chat-messages"
