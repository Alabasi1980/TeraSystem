...
import type { Data, Definition, Payload } from "@tera-system/schema/event"
...
import { Durable } from "@tera-system/schema/durable-event-manifest"

export const ID = Event.ID
export type ID = import("@tera-system/schema/event").ID
export type { Data, Definition, Payload } from "@tera-system/schema/event"
