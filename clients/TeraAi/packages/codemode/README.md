...
{
  "dependencies": {
    "@tera-system/codemode": "workspace:*"
  }
}
```
...
```ts
import { CodeMode, Tool } from "@tera-system/codemode"
...
```ts
import { CodeMode, OpenAPI } from "@tera-system/codemode"
...
```ts
import { toolError } from "@tera-system/codemode"
