...
import { compile, emitEffectImported, emitPromise, write } from "@tera-system/httpapi-codegen"
        ...
        emitPromise(contract, {
          outputTypes: {
            "events.subscribe": {
              ...
              import: 'import type { OpenCodeEventEncoded } from "@tera-system/protocol/groups/event"',
            },
          },
        }),
