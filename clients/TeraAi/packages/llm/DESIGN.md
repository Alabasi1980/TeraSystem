...
> current private `@tera-system/llm` API. Names and exact TypeScript signatures
> are illustrative until implementation, but the domain boundaries and defaults
> are deliberate.

## Status

- Proposed package: `@tera-system/ai`
...
import { LLM } from "@tera-system/ai"
import { OpenAI } from "@tera-system/ai/providers/openai"
...
```ts
import { Message } from "@tera-system/ai"
...
import { LLM, Tool } from "@tera-system/ai"
...
```ts
import { LLM } from "@tera-system/ai/promise"
import { OpenAI } from "@tera-system/ai/providers/openai"
...
```ts
import { LLMSchema } from "@tera-system/ai/schema"
...
```ts
import { Provider, Protocol } from "@tera-system/ai/provider"
...
@tera-system/ai/promise
  Promise/AsyncIterable LLM facade

@tera-system/ai/schema
  serializable domain schemas

@tera-system/ai/provider
  experimental Provider and Protocol authoring APIs

@tera-system/ai/providers/openai
@tera-system/ai/providers/anthropic
@tera-system/ai/providers/google
...
```
...
| Current                                 | Proposed                                                    |
| --------------------------------------- | ----------------------------------------------------------- |
| `@tera-system/llm`                      | `@tera-system/ai`                                           |
