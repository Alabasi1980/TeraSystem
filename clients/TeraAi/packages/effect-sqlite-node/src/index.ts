...
export const TypeId: TypeId = "~@tera-system/effect-sqlite-node/NodeSqliteClient"
export type TypeId = "~@tera-system/effect-sqlite-node/NodeSqliteClient"
...
export const SqliteClient = Context.Service<SqliteClient>("@tera-system/effect-sqlite-node/NodeSqliteClient")
