...
- يجب إضافة قواعد `MVP Anti-Bloat` داخل كل عميل قبل اعتماده كعميل فعّال، وتشمل:
  - عدم إضافة شاشات أو ملفات أو جداول غير مطلوبة.
  - اقتراح الدمج والتقليل قبل التوسيع.
  - عدم توسيع النطاق دون موافقة Tera.
  - الالتزام بالمرحلة الحالية فقط.
