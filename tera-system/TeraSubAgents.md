...
|---|---|---|---|---|
| Client Discovery Agent | `CLIENT_DISCOVERY_AGENT` | بداية مشروع عميل خارجي أو صياغة أسئلة يرسلها Majed للعميل | `project-inputs/`, `CLIENT_PROFILE.md`, `CONTACTS.md`, `TeraClientEngagementPolicy.md` | `Client Question Set`, `Client Discovery Notes` |
...
| Change Control Agent | `CHANGE_CONTROL_AGENT` | عند ظهور طلب جديد بعد اعتماد النطاق أو التصميم أو بدء التنفيذ | `11_CHANGE_CONTROL.md`, `03_SCOPE_OF_WORK.md`, `04_FEATURE_SCOPE_MATRIX.md`, `TeraClientChangeControlPolicy.md` | `Client Change Request Record`, `Change classification recommendation` |
