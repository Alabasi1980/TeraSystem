...
- كود .NET / C# الذي تسمح به المهمة ومسارات الكتابة.
- اختبارات أو أدلة تحقق مرتبطة بالمهمة عندما تسمح البنية والبيئة.
- ملاحظات تنفيذ تتضمن ما تم التحقق منه وما بقي غير متحقق.

> **التعريف الكامل:** `.opencode/agents/engineering-agent-dotnet.md` — عقد تنفيذ .NET قائم على تصنيف نوع التطبيق، قواعد سلامة مشروطة، STOP/ASK، وأدلة تحقق؛ لا يفرض طبقات أو مكتبات أو أنماطاً افتراضية.
