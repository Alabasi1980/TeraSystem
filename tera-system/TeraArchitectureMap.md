...
| System evolution governance | Controls self-improvement of Tera: agent review, agent self-reported gaps, anti-bloat gate, change proposals, evolution logging, and continuous improvement policy via `TeraSystemEvolutionAgent` | `project-control/SYSTEM_EVOLUTION_LOG.md`, `project-control/AGENT_GAPS_LOG.md`, `tera-system/TERA_CONTINUOUS_IMPROVEMENT_POLICY.md`, `TeraSystemMaintenanceChecklist.md`, `.opencode/agents/tera-system-evolution.md` |
